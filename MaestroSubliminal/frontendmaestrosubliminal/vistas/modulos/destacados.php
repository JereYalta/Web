...
$titulosModulos = array("PRODUCTOS GRATUITOS", "LO MÁS VENDIDO", "LO MÁS VISTO");
$rutaModulos = array("articulos-gratis","lo-mas-vendido","lo-mas-visto");

$base = 0;
$tope = 4;

if($titulosModulos[0] == "PRODUCTOS GRATUITOS"){
					...
					<div class="col-xs-12 organizarProductos">
						...
						<div class="btn-group pull-right">
							 ...
							 <button type="button" class="btn btn-default btnGrid" id="btnGrid'.$i.'">
								...
								<span class="col-xs-0 pull-right"></span>
					...
					echo '<li class="col-md-3 col-sm-6 col-xs-12">
								...
								<small>
									...
									<a href="'.$value["ruta"].'" class="pixelProducto">
										...
										if($fechaNueva < $value["fecha"]){
											...
											echo '<span class="label  fontSize" style="background-color: #fdb813">Nuevo</span> ';
							...
							<div class="col-xs-6 enlaces">
								...
								<div class="btn-group pull-right">
									...
									<button type="button" class="btn btn-default btn-xs deseos" idProducto="
								...
								<small>
									...
									<a href="'.$value["ruta"].'" class="pixelProducto">
										...
										if($fechaNueva < $value["fecha"]){
											...
											echo '<span class="label " style="background-color: #fdb813">Nuevo</span> ';
