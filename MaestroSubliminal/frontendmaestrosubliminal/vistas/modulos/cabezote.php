...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <?php
       echo '   <li><a href="'.$url.'faq">FAQ</a></li>
        ...
        <?php
				...
				if(isset($_SESSION["validarSesion"])){
					...
					if($_SESSION["validarSesion"] == "ok"){
						...
						if($_SESSION["modo"] == "google"){
							...
							echo '<li>
								   ...
								   <li>|</li>
						 		   <li><a href="'.$url.'perfil"><span class="glyphicon glyphicon-user">
								</span>Ver Perfil</a></li>
						 		   <li>|</li>
						 		   <li><a href="'.$url.'salir">Salir</a></li>';
					...
					echo '
								...
								<li><a href="#modalIngreso" data-toggle="modal"><span class="glyphicon glyphicon-user">
								</span> Ingresar</a></li>
							</a>
						
							
								<li><a href="#modalRegistro" data-toggle="modal">
								<span class="glyphicon glyphicon-log-in"></span> Regístrate</a></li>
							</a>		
	...
	<div class="container">
		...
		<div class="row" id="cabezote">
			...
			<div class="col-md-6 col-sm-8 col-xs-12">
				...
				<div class="col-md-3 col-sm-4 col-xs-12 " id="btnCategorias" >
			...
			<div class="col-md-3 col-sm-2 col-xs-12" id="carrito">
				...
				<a href="<?php echo $url;?>carrito-de-compras">
					...
					<button class="btn btn-default backColor pull-left " > 
				...
				<p>Productos <span class="cantidadCesta"></span> <br> USD $ <span class="sumaCesta"></span></p>	
		...
		<!--=====================================
			...
			<div class="col-md-3 col-sm-4 col-xs-12 registro">
				...
				if(isset($_SESSION["validarSesion"])){
					...
					echo '
						<div class="ingresobtn">
							<button class="btn btn-default  btn-md ">
								<li><a href="#modalIngreso" data-toggle="modal">Ingresar</a></li>
							</a>
							</button>
							<button class="btn btn-default  btn-md backColor ">
								<li><a href="#modalRegistro" data-toggle="modal">Regístrate</a></li>
							</a>		
								</button>				  
							</div>					  ';
		...
		<div class="col-xs-12 " style="background-color: #f2f6fa" id="categorias">
...
<div class="modal fade modalFormulario" id="modalRegistro" role="dialog">
    ...
    <div class="modal-content modal-dialog">
        ...
        <div class="modal-body modalTitulo">
        	...
        	<h3 class="" style="background-color: #f2f6fa">REGISTRARSE</h3>
           ...
           <button type="button" class="close" data-dismiss="modal">&times;</button>
			...
			<hr>
				...
				<input type="submit" class="btn btn-default backColor btn-block" style="background-color: #ffcb00" value="ENVIAR">	
...
<div class="modal fade modalFormulario" id="modalIngreso" role="dialog">
    ...
    <div class="modal-content modal-dialog">
        ...
        <div class="modal-body modalTitulo">
        	...
        	<h3 class="" style="background-color: #f2f6fa">INGRESAR</h3>
...
<div class="modal fade modalFormulario" id="modalPassword" role="dialog">
    ...
    <div class="modal-content modal-dialog">
        ...
        <div class="modal-body modalTitulo">
        	...
        	<h3 class="" style="background-color: #f2f6fa">SOLICITUD DE NUEVA CONTRASEÑA</h3>
