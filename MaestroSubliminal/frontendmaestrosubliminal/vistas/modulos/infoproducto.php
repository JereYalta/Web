			...
			?>
				...
				<div class="col-xs-6">
					...
					<h6>
						...
						<a href="javascript:history.back()" class="text-muted">
							...
							<i class="fa fa-reply"></i> <b>Continuar Comprando</b>
				...
				<div class="col-xs-6">
					...
					<h6>
						...
						<a class="dropdown-toggle pull-right text-muted" data-toggle="dropdown" href="">
							...
							<i class="fa fa-plus"></i> <b> Compartir</b>
				...
				<?php
					...
					echo '<div class="comprarAhora" style="display:none">
						...
						<button class="btn btn-default  quitarItemCarrito" idProducto="'.$infoproducto["id"].'" peso="'.$infoproducto["peso"].'"></button>
						

						<p class="tituloCarritoCompra text-left"><b>'.$infoproducto["titulo"].'</b></p> ';
					...
					if($infoproducto["oferta"] == 0){
						...
						if($fechaNueva > $infoproducto["fecha"]){
							...
							echo '<b><h2 class="text-muted text-uppercase">'.$infoproducto["titulo"].'</h2>';
						...
						if($fechaNueva > $infoproducto["fecha"]){
							...
							echo '<h3 class="text-muted text-uppercase">'.$infoproducto["titulo"].'
					...
					TITULO
					=============================================*/	
					echo '<h4> de '.$infoproducto["id_editor"].'</h4>';	

					if($infoproducto["precio"] == 0){

						echo '<strong><h3 class="text-muted">GRATIS</h3></strong>';

					}else{

						if($infoproducto["oferta"] == 0){

							echo '<h3 class="text-muted">USD $'.$infoproducto["precio"].'</h3>';
						...
						if($infoproducto["tipo"]=="virtual"){
							...
							echo '</div>
								...
								if($infoproducto["oferta"] != 0){
									...
									echo '<button class="btn btn-default btn-block btn-lg  agregarCarrito backColor"  idProducto="'.$infoproducto["id"].'" imagen="'.$servidor.$infoproducto["portada"].'" titulo="'.$infoproducto["titulo"].'" precio="'.$infoproducto["precioOferta"].'" tipo="'.$infoproducto["tipo"].'" peso="'.$infoproducto["peso"].'">';

								}else{

									echo '<button class="btn btn-default btn-block btn-lg  agregarCarrito backColor"  idProducto="'.$infoproducto["id"].'" imagen="'.$servidor.$infoproducto["portada"].'" titulo="'.$infoproducto["titulo"].'" precio="'.$infoproducto["precio"].'" tipo="'.$infoproducto["tipo"].'" peso="'.$infoproducto["peso"].'">';
							...
							if($infoproducto["oferta"] != 0){
									...
									echo '<button class="btn btn-default btn-block btn-lg  agregarCarrito"  idProducto="'.$infoproducto["id"].'" imagen="'.$servidor.$infoproducto["portada"].'" titulo="'.$infoproducto["titulo"].'" precio="'.$infoproducto["precioOferta"].'" tipo="'.$infoproducto["tipo"].'" peso="'.$infoproducto["peso"].'">';

								}else{

									echo '<button class="btn btn-default btn-block btn-lg  agregarCarrito"  idProducto="'.$infoproducto["id"].'" imagen="'.$servidor.$infoproducto["portada"].'" titulo="'.$infoproducto["titulo"].'" precio="'.$infoproducto["precio"].'" tipo="'.$infoproducto["tipo"].'" peso="'.$infoproducto["peso"].'">';
