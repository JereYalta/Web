								...
								<div class="btn-group pull-right">
									...
									if($value["tipo"] == "virtual" && $value["precio"] != 0){
										...
										if($value["oferta"] != 0){
											...
											echo '<button type="button" class="btn btn-default btn-xs agregarCarrito"  idProducto="'.$value["id_editor"].'" imagen="'.$servidor.$value["portada"].'" titulo="'.$value["titulo"].'" precio="'.$value["precioOferta"].'" tipo="'.$value["tipo"].'" peso="'.$value["peso"].'" data-toggle="tooltip" title="Agregar al carrito de compras">
				...
				foreach ($productos as $key => $value) {
					...
					if($value["estado"] != 0){
						...
						<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
							...
							<p class="text-muted">'.$value["titular"].'</p> <br>
							 de '.$value["id_editor"].'' ;
