...
class AjaxProductos{
	...
	public function  ajaxCrearProducto(){
		...
		$datos = array(
			...
			"editor"=>$this->seleccionarEditor,					
			"categoria"=>$this->seleccionarCategoria,
			"subCategoria"=>$this->seleccionarSubCategoria,
			"descripcionProducto"=>$this->descripcionProducto,
			"descriProducto"=>$this->descriProducto,
			"linkProducto"=>$this->linkProducto,
...
if(isset($_POST["tituloProducto"])){
	...
	$producto -> seleccionarEditor = $_POST["seleccionarEditor"];		
	...
	$producto -> descriProducto = $_POST["descriProducto"];
	$producto -> linkProducto = $_POST["linkProducto"];
	...
	$producto -> multimedia1 = $_POST["multimedia1"];
...
if(isset($_POST["id"])){
	...
	$editarProducto -> seleccionarEditor = $_POST["seleccionarEditor"];
	...
	$editarProducto -> descriProducto = $_POST["descriProducto"];
	$editarProducto -> linkProducto = $_POST["linkProducto"];
	...
	$editarProducto -> multimedia1 = $_POST["multimedia1"];
