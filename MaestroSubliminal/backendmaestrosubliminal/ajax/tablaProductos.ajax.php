...
class TablaProductos{
  ...
  public function mostrarTablaProductos(){	
  	...
  	$productos = ControladorProductos::ctrMostrarProductosporEditor($idEditor);
if(count($productos)>0){
      ...
      $item1 = "id";
      $valor1 = $productos[$i]["id_subcategoria"];

      $subcategorias = ControladorSubCategorias::ctrMostrarSubCategorias($item1, $valor1);
      ...
      if($subcategorias[0]["subcategoria"] == ""){
        ...
        $subcategoria = $subcategorias[0]["subcategoria"];
			...
			/*=============================================
  			...
  			$item2 = "editor";
			$valor2 = $productos[$i]["id_editor"];

			$administradores = ControladorAdministradores::ctrMostrarAdministradores($item2, $valor2);


			if($administradores["editor"] == ""){

				$editor = "SIN SUBCATEGORÍA";
			
			}else{

				$editor= $administradores["editor"];
			}
      ...
      TRAER MULTIMEDIA 1
        ...
        if($productos[$i]["multimedia1"] != null){

          $multimedia1 = json_decode($productos[$i]["multimedia1"],true);
          ...
          $vistaMultimedia1 = "<img src='vistas/img/multimedia1/default/default.jpg' class='img-thumbnail imgTablaMultimedia' width='100px'>";
          ...
          if(!isset($detalles["Dispositivo"])){
            $detalles["Dispositivo"] = "";
          }
          if(!isset($detalles["Certificado"])){
...
//$id= $_POST ="id";
    ...
    //    if(isset($_GET["perfilId"]) && $_GET["perfilId"] == "$id"){}
...
$datosJson .='[
         ...
         "'.$editor.'",
          ...
          "'.$productos[$i]["descriProducto"].'",
          "'.$productos[$i]["linkProducto"].'",
            "'.$productos[$i]["multimedia1"].'",
