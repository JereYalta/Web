...
$('.tablaProductos').DataTable({
	...
	"ajax":"ajax/tablaProductos.ajax.php?idUsuario="+idUsuario,
	"deferRender": true,
	"retrieve": true,
	"processing": true,
    "language": {
...
function agregarMiProducto(imagen){
		...
		var seleccionarEditor = $(".seleccionarEditor").val();
	    ...
	    var descriProducto = $(".descripcionProducto").val();
	    var linkProducto = $(".linkProducto").val();
	    var multimedia1 = $(".multimedia1").val();
		...
		datosProducto.append("seleccionarEditor", seleccionarEditor);
		...
		datosProducto.append("descriProducto", descriProducto);
		datosProducto.append("linkProducto", linkProducto);
		datosProducto.append("multimedia1", multimedia1);
...
$('.tablaProductos tbody').on("click", ".btnEditarProducto", function(){
	...
	/*=============================================
			...
			if(respuesta[0]["id_editor"] != 0){

				var datosEditor = new FormData();
				datosEditor.append("idEditor", respuesta[0]["id_editor"]);
				...
				$.ajax({
						...
						console.log("respuesta", respuesta);
							...
							$("#modalEditarProducto .seleccionarEditor").val(respuesta[0]["id"]);
							$("#modalEditarProducto .optionEditarEditor").html(respuesta[0]["editor"]);
				...
				$("#modalEditarProducto .optionEditarEditor").html("SIN CATEGORÍA");
			...
			$.ajax({
					...
					success: function(respuesta){
						...
						/*=============================================
						CARGAMOS LA DESCRIPCION LINKPRODUCTO MULTIMEDIA1
						=============================================*/

						$("#modalEditarProducto .descripcionProducto").val(respuesta["descripcion"]);
						$("#modalEditarProducto .descriProducto").val(respuesta["descriProducto"]);

						$("#modalEditarProducto .multimedia1").val(respuesta["multimedia1"]);
						$("#modalEditarProducto .linkProducto").val(respuesta["linkProducto"]);
			...
			$(".guardarCambiosProducto").click(function(){
					...
					if($("#modalEditarProducto .tituloProducto").val() != "" &&
					   ...
					   $("#modalEditarProducto .seleccionarEditor").val() != "" &&
					   $("#modalEditarProducto .descripcionProducto").val() != "" &&
					    $("#modalEditarProducto .descriProducto").val() != "" &&
					     $("#modalEditarProducto .linkProducto").val() != "" &&
					      $("#modalEditarProducto .multimedia1").val() != "" &&
...
function editarMiProducto(imagen){
	...
	var seleccionarEditor = $("#modalEditarProducto .seleccionarEditor").val();
	...
	var descriProducto = $("#modalEditarProducto .descriProducto").val();
	var linkProducto = $("#modalEditarProducto .linkProducto").val();
	var multimedia1 = $("#modalEditarProducto .multimedia1").val();
