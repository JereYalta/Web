...
class ControladorProductos{
	...
	static public function ctrMostrarProductosporEditor($idEditor){

		$tabla = "productos";

		$respuesta = ModeloProductos::mdlMostrarProductosporEditor($tabla,$idEditor);
	...
	static public function ctrCrearProducto($datos){
		...
		if(isset($datos["tituloProducto"])){
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $datos["tituloProducto"]) && preg_match('/^[,\\.\\a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["descripcionProducto"]) && preg_match('/^[,\\.\\a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["descriProducto"]) ){
