...
class ModeloAdministradores{
	...
	static public function mdlIngresarPerfil($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(editor, email, password, perfil, foto, estado) VALUES (:editor, :email, :password, :perfil, :foto, :estado)");

		$stmt->bindParam(":editor", $datos["editor"], PDO::PARAM_STR);
	...
	static public function mdlEditarPerfil($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET editor = :editor, email = :email, password = :password, perfil = :perfil, foto = :foto WHERE id = :id");
