...
class ModeloProductos{
	...
	static public function mdlActualizarOfertaProductos($tabla, $datos, $ofertadoPor, $precioOfertaActualizado, $descuentoOfertaActualizado, $idOferta){
		...
		/*=============================================
	MOSTRAR PRODUCTOS  POR EDITOR
	=============================================*/

	static public function mdlMostrarProductosporEditor($tabla, $idEditor){
...
$query = "SELECT * FROM $tabla WHERE id_editor = '".$id."' ORDER BY id DESC";
	...
	static public function mdlIngresarProducto($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_categoria, id_subcategoria, id_editor, tipo, ruta, estado, titulo, titular, descripcion, descriProducto,   multimedia, multimedia1, linkProducto, detalles, precio, portada, oferta, precioOferta, descuentoOferta, imgOferta, finOferta, peso, entrega) VALUES (:id_categoria, :id_subcategoria, :id_editor, :tipo, :ruta, :estado, :titulo, :titular, :descripcion, :descriProducto, :multimedia, :multimedia1,  :linkProducto, :detalles, :precio, :portada, :oferta, :precioOferta, :descuentoOferta, :imgOferta, :finOferta,  :peso, :entrega)");
		...
		$stmt->bindParam(":id_editor", $datos["idEditor"], PDO::PARAM_STR);
		...
		$stmt->bindParam(":descriProducto", $datos["descriProducto"], PDO::PARAM_STR);
		$stmt->bindParam(":multimedia", $datos["multimedia"], PDO::PARAM_STR);
		$stmt->bindParam(":multimedia1", $datos["multimedia1"], PDO::PARAM_STR);
		$stmt->bindParam(":linkProducto", $datos["linkProducto"], PDO::PARAM_STR);
	...
	static public function mdlEditarProducto($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET id_categoria = :id_categoria, id_subcategoria = :id_subcategoria, id_editor = :id_editor, tipo = :tipo, ruta = :ruta, estado = :estado, titulo = :titulo, titular = :titular, descripcion = :descripcion, descriProducto = :descriProducto,  multimedia = :multimedia, multimedia1 = :multimedia1,  linkProducto = :linkProducto, detalles = :detalles, precio = :precio, portada = :portada, oferta = :oferta, precioOferta = :precioOferta, descuentoOferta = :descuentoOferta, imgOferta = :imgOferta, finOferta = :finOferta, peso = :peso, entrega = :entrega WHERE id = :id");
